...
const Hero = () => {
  ...
  return (
    ...
    className="h-screen flex flex-col items-center justify-center text-center gap-14 bg-light">
  ...
  whileTap={{scale: 0.95}}
  className="w-full md:w-auto mt-4 md:mt-0 flex items-center justify-center gap-1 px-9 py-3 bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer">
